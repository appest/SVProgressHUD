Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
    ...
    core.resource_bundles = {'SVProgressHUDPrivacyInfo' => ['SVProgressHUD/PrivacyInfo.xcprivacy']}
  end

  s.subspec 'AppExtension' do |ext|
    ext.source_files = 'SVProgressHUD/*.{h,m}'
    ext.resources = ['SVProgressHUD/SVProgressHUD.bundle']
    ext.resource_bundles = {'AppExtensionPrivacyInfo' => ['SVProgressHUD/PrivacyInfo.xcprivacy']}
